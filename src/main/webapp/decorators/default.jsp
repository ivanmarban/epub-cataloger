...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="all" href="<c:url value='/styles/lib/bootstrap-2.3.1.min.css'/>" />
    <link rel="stylesheet" type="text/css" media="all" href="<c:url value='/styles/lib/bootstrap-responsive-2.3.1.min.css'/>" />
    <link rel="stylesheet" type="text/css" media="all" href="<c:url value='/styles/style.css'/>" />
    
    <link rel="stylesheet" type="text/css" media="all" href="<c:url value='/styles/lib/bootstrap-fileupload.css'/>" />
    ...
    <script type="text/javascript" src="<c:url value='/scripts/lib/bootstrap-2.3.1.min.js'/>"></script>
            ...
            <div class="container-fluid">
                ...
                <c:if test="${pageContext.request.locale.language != 'es'}">
                    <div id="switchLocale"><a href="<c:url value='/?locale=es'/>">
                        <fmt:message key="webapp.name"/> en Espa&ntilde;ol</a>
                    </div>
                </c:if>
                -->
            </div>
