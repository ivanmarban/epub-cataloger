...
import com.github.ivanmarban.Constants;
...
import com.github.ivanmarban.webapp.util.RequestUtil;
...
public class UserAction extends BaseAction implements Preparable {
    ...
    public String delete() throws IOException {
    	...
    	/* borramos directorio y todos los registros del usuario */
        
        epubManager.deleteEpubsByUser(user.getUsername());
